...
export const mockTasks: Task[] = [
  ...
  {
    id: 'task_6',
    content: 'Pick up groceries from Costco',
  ...
  {
    id: 'task_7',
    content: 'Call bank about account issue',
    description: 'Need to resolve billing discrepancy',
    projectId: 'project_personal',
    priority: 3,
    labels: ['urgent'],
  ...
  {
    id: 'task_8',
    content: 'Install new shelves in garage',
